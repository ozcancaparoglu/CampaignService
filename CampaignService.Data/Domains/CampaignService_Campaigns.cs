...
{
    public partial class CampaignService_Campaigns : EntityBase
    {
        public CampaignService_Campaigns()
        {
            CampaignServiceCampaignCouponCodes = new HashSet<CampaignService_CampaignCouponCode>();
            CampaignServiceCampaignCouponUsages = new HashSet<CampaignService_CampaignCouponUsage>();
            CampaignServiceCampaignUsageHistories = new HashSet<CampaignService_CampaignUsageHistory>();
        }
        ...
        public virtual ICollection<CampaignService_CampaignCouponCode> CampaignServiceCampaignCouponCodes { get; set; }
        public virtual ICollection<CampaignService_CampaignCouponUsage> CampaignServiceCampaignCouponUsages { get; set; }
        public virtual ICollection<CampaignService_CampaignUsageHistory> CampaignServiceCampaignUsageHistories { get; set; }
    }
}
